...
class MyTextToSpeech extends StatefulWidget {
  const MyTextToSpeech({Key? key}) : super(key: key);

  @override
  _MyTextToSpeech createState() => _MyTextToSpeech();
}

enum TtsState { playing, stopped, paused, continued }

class _MyTextToSpeech extends State<MyTextToSpeech> {
  ...
  Widget _languageDropDownSection(List<dynamic> languages) {
    // List<String> langNames = ConvertLanguage(languages);
    return Container(
