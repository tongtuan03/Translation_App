...
class LanguageDropdown extends StatefulWidget {
  ...
  const LanguageDropdown({super.key, required this.onLanguageChanged, this.selectedCountry});
...
class _LanguageDropdownState extends State<LanguageDropdown> {
  final List<Map<String, String>> languageData = [
    ...
    {'countryLanguage': 'Spanish', 'countryImage': 'assets/images/spain.png'},
    {'countryLanguage': 'Vietnamese', 'countryImage': 'assets/images/vietnam.png'},
  ];
            ...
            child: Row(
              ...
              children: [
                ...
                Text(
                  ...
                  style: GoogleFonts.poppins(
                    fontSize: 14.0,
                    color: widget.selectedCountry == country['countryLanguage']
